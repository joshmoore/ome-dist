...
namespace omero {
  namespace model {
    class OMERO_API BooleanAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::BooleanAnnotationI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API BooleanAnnotationI : virtual public BooleanAnnotation {
   public:
