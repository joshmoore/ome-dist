   ...
   **
   */
#ifndef BOOLEANANNOTATIONI_H
#define BOOLEANANNOTATIONI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT BooleanAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::BooleanAnnotationI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<BooleanAnnotationI> BooleanAnnotationIPtr;
#else
  typedef IceUtil::Handle<BooleanAnnotationI> BooleanAnnotationIPtr;
#endif
    class OMERO_CLIENT BooleanAnnotationI : virtual public BooleanAnnotation {
   public:
      static const std::string BOOLVALUE;
    ...
    protected:
      ...
      virtual ~BooleanAnnotationI();
    public:
      BooleanAnnotationI();
      BooleanAnnotationI(omero::RLongPtr idPtr, bool isLoaded = false);
      BooleanAnnotationI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  BooleanAnnotation.boolValue
      //
      virtual void unloadBoolValue();
      virtual omero::RBoolPtr getBoolValue(const Ice::Current& current = Ice::Current());
      virtual void setBoolValue(const omero::RBoolPtr& _boolValue, const Ice::Current& current = Ice::Current());

      //
      //  BooleanAnnotation.ns
      //
      ...
      //
      //  BooleanAnnotation.annotationLinks
      //
