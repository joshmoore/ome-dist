...
namespace omero {
  ...
  typedef IceInternal::Handle<ChannelBindingI> ChannelBindingIPtr;
   ...
   public:
    ...
    protected:
      virtual ChannelBindingSpatialDomainEnhancementSeq getSpatialDomainEnhancement(const Ice::Current& current = Ice::Current());
      virtual void setSpatialDomainEnhancement(const ChannelBindingSpatialDomainEnhancementSeq& _spatialDomainEnhancement, const Ice::Current& current = Ice::Current());
    public:
      ...
      virtual ChannelBindingSpatialDomainEnhancementSeq copySpatialDomainEnhancement(const Ice::Current& current = Ice::Current());
      virtual ChannelBindingSpatialDomainEnhancementSeq::iterator beginSpatialDomainEnhancement();
      virtual ChannelBindingSpatialDomainEnhancementSeq::iterator endSpatialDomainEnhancement();
      virtual void addCodomainMapContext(const CodomainMapContextPtr& target, const Ice::Current& current = Ice::Current());
      virtual void addAllCodomainMapContextSet(const ChannelBindingSpatialDomainEnhancementSeq& targets, const Ice::Current& current = Ice::Current());
      virtual void removeCodomainMapContext(const CodomainMapContextPtr& target, const Ice::Current& current = Ice::Current());
      virtual void removeAllCodomainMapContextSet(const ChannelBindingSpatialDomainEnhancementSeq& targets, const Ice::Current& current = Ice::Current());
      virtual void clearSpatialDomainEnhancement(const Ice::Current& current = Ice::Current());
      virtual void reloadSpatialDomainEnhancement(const ChannelBindingPtr& toCopy, const Ice::Current& current = Ice::Current());
