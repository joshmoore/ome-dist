...
namespace omero {
  namespace model {
    class OMERO_API ChannelBindingI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ChannelBindingI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<ChannelBindingI> ChannelBindingIPtr;
#endif
    class OMERO_API ChannelBindingI : virtual public ChannelBinding {
   public:
