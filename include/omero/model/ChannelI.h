...
namespace omero {
  namespace model {
    class OMERO_API ChannelI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ChannelI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API ChannelI : virtual public Channel {
   public:
    ...
    public:
      ...
      virtual void addChannelAnnotationLinkToBoth(const ChannelAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
