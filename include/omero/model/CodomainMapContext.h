...
class CodomainMapContext : virtual public ::omero::model::IObject
{
public:
    ...
    CodomainMapContext() {}
    CodomainMapContext(const ::omero::RLongPtr&, const ::omero::model::DetailsPtr&, bool, const ::omero::RIntPtr&, const ::omero::model::RenderingDefPtr&);
