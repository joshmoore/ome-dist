...
namespace omero {
  namespace model {
    class OMERO_API CommentAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::CommentAnnotationI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API CommentAnnotationI : virtual public CommentAnnotation {
   public:
