...
namespace omero {
  namespace model {
    class OMERO_API ContrastStretchingContextI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ContrastStretchingContextI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<ContrastStretchingContextI> ContrastStretchingContextIPtr;
#endif
    class OMERO_API ContrastStretchingContextI : virtual public ContrastStretchingContext {
   public:
