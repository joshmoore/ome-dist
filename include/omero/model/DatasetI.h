...
namespace omero {
  namespace model {
    class OMERO_API DatasetI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::DatasetI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<DatasetI> DatasetIPtr;
#endif
    class OMERO_API DatasetI : virtual public Dataset {
   public:
    ...
    public:
      ...
      virtual void addDatasetAnnotationLinkToBoth(const DatasetAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
