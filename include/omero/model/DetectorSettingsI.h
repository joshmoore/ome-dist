...
namespace omero {
  namespace model {
    class OMERO_API DetectorSettingsI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::DetectorSettingsI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API DetectorSettingsI : virtual public DetectorSettings {
   public:
    ...
    public:
      ...
      virtual omero::RDoublePtr getReadOutRate(const Ice::Current& current = Ice::Current());
      virtual void setReadOutRate(const omero::RDoublePtr& _readOutRate, const Ice::Current& current = Ice::Current());
