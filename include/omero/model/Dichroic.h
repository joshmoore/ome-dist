...
public:
    ...
    ::IceInternal::ProxyHandle<Dichroic> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<Dichroic*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
