...
namespace omero {
  namespace model {
    class OMERO_CLIENT DimensionOrderI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::DimensionOrderI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT DimensionOrderI : virtual public DimensionOrder {
   public:
