...
namespace omero {
  namespace model {
    class OMERO_API DoubleAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::DoubleAnnotationI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API DoubleAnnotationI : virtual public DoubleAnnotation {
   public:
