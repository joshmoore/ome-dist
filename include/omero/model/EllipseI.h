...
namespace omero {
  ...
  typedef IceInternal::Handle<EllipseI> EllipseIPtr;
   ...
   public:
      ...
      static const std::string RADIUSX;
      static const std::string RADIUSY;
    ...
    public:
      ...
      //  Ellipse.radiusX
      //
      virtual void unloadRadiusX();
      virtual omero::RDoublePtr getRadiusX(const Ice::Current& current = Ice::Current());
      virtual void setRadiusX(const omero::RDoublePtr& _radiusX, const Ice::Current& current = Ice::Current());

      //
      //  Ellipse.radiusY
      //
      virtual void unloadRadiusY();
      virtual omero::RDoublePtr getRadiusY(const Ice::Current& current = Ice::Current());
      virtual void setRadiusY(const omero::RDoublePtr& _radiusY, const Ice::Current& current = Ice::Current());
