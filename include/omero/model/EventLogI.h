...
namespace omero {
  namespace model {
    class OMERO_API EventLogI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::EventLogI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<EventLogI> EventLogIPtr;
#endif
    class OMERO_API EventLogI : virtual public EventLog {
   public:
