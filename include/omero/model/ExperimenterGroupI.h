...
namespace omero {
  namespace model {
    class OMERO_API ExperimenterGroupI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ExperimenterGroupI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<ExperimenterGroupI> ExperimenterGroupIPtr;
#endif
    class OMERO_API ExperimenterGroupI : virtual public ExperimenterGroup {
   public:
    ...
    public:
      ...
      virtual void addExperimenterGroupAnnotationLinkToBoth(const ExperimenterGroupAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
