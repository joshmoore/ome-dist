...
namespace omero {
  namespace model {
    class OMERO_API ExperimenterI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ExperimenterI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API ExperimenterI : virtual public Experimenter {
   public:
    ...
    public:
      ...
      virtual void addExperimenterAnnotationLinkToBoth(const ExperimenterAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
