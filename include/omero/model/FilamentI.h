...
namespace omero {
  namespace model {
    class OMERO_API FilamentI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::FilamentI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<FilamentI> FilamentIPtr;
#else
  typedef IceUtil::Handle<FilamentI> FilamentIPtr;
#endif
    class OMERO_API FilamentI : virtual public Filament {
   public:
    ...
    public:
      FilamentI();
      FilamentI(omero::RLongPtr idPtr, bool isLoaded = false);
      FilamentI(Ice::Long id, bool isLoaded = false);
      ...
      virtual omero::model::FilamentTypePtr getType(const Ice::Current& current = Ice::Current());
      virtual void setType(const omero::model::FilamentTypePtr& _type, const Ice::Current& current = Ice::Current());
