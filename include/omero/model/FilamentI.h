...
namespace omero {
  namespace model {
    class OMERO_CLIENT FilamentI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::FilamentI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT FilamentI : virtual public Filament {
   public:
