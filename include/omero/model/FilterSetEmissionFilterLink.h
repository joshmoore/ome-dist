...
public:
    ...
    ::IceInternal::ProxyHandle<FilterSetEmissionFilterLink> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<FilterSetEmissionFilterLink*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
public:
    ...
    FilterSetEmissionFilterLink(const ::omero::RLongPtr& __ice_id, const ::omero::model::DetailsPtr& __ice_details, bool __ice_loaded, const ::omero::RIntPtr& __ice_version, const ::omero::model::FilterSetPtr& __ice_parent, const ::omero::model::FilterPtr& __ice_child) :
