   ...
   **
   */
#ifndef GENERICEXCITATIONSOURCEI_H
#define GENERICEXCITATIONSOURCEI_H
#include <omero/IceNoWarnPush.h>
#include <omero/RTypes.h>
#include <omero/model/RTypes.h>
#include <omero/model/IObject.h>
#include <omero/model/GenericExcitationSource.h>
...
namespace omero {
  namespace model {
    class OMERO_CLIENT GenericExcitationSourceI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::GenericExcitationSourceI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<GenericExcitationSourceI> GenericExcitationSourceIPtr;
#else
  typedef IceUtil::Handle<GenericExcitationSourceI> GenericExcitationSourceIPtr;
#endif
    class OMERO_CLIENT GenericExcitationSourceI : virtual public GenericExcitationSource {
   public:
    ...
    protected:
      ...
      virtual ~GenericExcitationSourceI();
    public:
      GenericExcitationSourceI();
      GenericExcitationSourceI(omero::RLongPtr idPtr, bool isLoaded = false);
      GenericExcitationSourceI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  GenericExcitationSource.manufacturer
      //
      ...
      //
      //  GenericExcitationSource.lotNumber
      //
      ...
      //
      //  GenericExcitationSource.serialNumber
      //
      ...
      //
      //  GenericExcitationSource.instrument
      //
      ...
      //
      //  GenericExcitationSource.annotationLinks
      //
...
#endif // GENERICEXCITATIONSOURCEI_H
