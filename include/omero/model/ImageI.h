...
namespace omero {
  namespace model {
    class OMERO_API ImageI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ImageI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<ImageI> ImageIPtr;
#endif
    class OMERO_API ImageI : virtual public Image {
   public:
    ...
    public:
      ...
      virtual void addImageAnnotationLinkToBoth(const ImageAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
