...
namespace omero {
  ...
  typedef IceInternal::Handle<ImageI> ImageIPtr;
   ...
   public:
    ...
    protected:
      virtual ImageFolderLinksSeq getFolderLinks(const Ice::Current& current = Ice::Current());
      virtual void setFolderLinks(const ImageFolderLinksSeq& _folderLinks, const Ice::Current& current = Ice::Current());
    public:
      virtual bool isFolderLinksLoaded();
      virtual Ice::Int sizeOfFolderLinks(const Ice::Current& current = Ice::Current());
      virtual ImageFolderLinksSeq copyFolderLinks(const Ice::Current& current = Ice::Current());
      virtual ImageFolderLinksSeq::iterator beginFolderLinks();
      virtual ImageFolderLinksSeq::iterator endFolderLinks();
      virtual void addFolderImageLink(const FolderImageLinkPtr& target, const Ice::Current& current = Ice::Current());
      virtual void addAllFolderImageLinkSet(const ImageFolderLinksSeq& targets, const Ice::Current& current = Ice::Current());
      virtual void removeFolderImageLink(const FolderImageLinkPtr& target, const Ice::Current& current = Ice::Current());
      virtual void removeAllFolderImageLinkSet(const ImageFolderLinksSeq& targets, const Ice::Current& current = Ice::Current());
      virtual void clearFolderLinks(const Ice::Current& current = Ice::Current());
      virtual void reloadFolderLinks(const ImagePtr& toCopy, const Ice::Current& current = Ice::Current());
      virtual omero::sys::CountMap getFolderLinksCountPerOwner(const Ice::Current& current = Ice::Current());
      virtual FolderImageLinkPtr linkFolder(const FolderPtr& addition, const Ice::Current& current = Ice::Current());
      virtual void addFolderImageLinkToBoth(const FolderImageLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
      virtual ImageFolderLinksSeq findFolderImageLink(const FolderPtr& removal, const Ice::Current& current = Ice::Current());
      ...
      virtual void removeFolderImageLinkFromBoth(const FolderImageLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
       virtual ImageLinkedFolderSeq linkedFolderList(const Ice::Current& current = Ice::Current());
