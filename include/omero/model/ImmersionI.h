...
namespace omero {
  namespace model {
    class OMERO_API ImmersionI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ImmersionI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<ImmersionI> ImmersionIPtr;
#endif
    class OMERO_API ImmersionI : virtual public Immersion {
   public:
