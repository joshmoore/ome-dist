   ...
   **
   */
#ifndef INDEXINGJOBI_H
#define INDEXINGJOBI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT IndexingJobI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::IndexingJobI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<IndexingJobI> IndexingJobIPtr;
#else
  typedef IceUtil::Handle<IndexingJobI> IndexingJobIPtr;
#endif
    class OMERO_CLIENT IndexingJobI : virtual public IndexingJob {
   public:
    ...
    protected:
      ...
      virtual ~IndexingJobI();
    public:
      IndexingJobI();
      IndexingJobI(omero::RLongPtr idPtr, bool isLoaded = false);
      IndexingJobI(Ice::Long id, bool isLoaded = false);
