...
namespace omero {
  namespace model {
    class OMERO_API InstrumentI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::InstrumentI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<InstrumentI> InstrumentIPtr;
#endif
    class OMERO_API InstrumentI : virtual public Instrument {
   public:
