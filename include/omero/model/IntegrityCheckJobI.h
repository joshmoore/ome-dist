...
namespace omero {
  namespace model {
    class OMERO_CLIENT IntegrityCheckJobI;
  }
}
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::IntegrityCheckJobI*);
}
namespace omero {
  namespace model {
  typedef IceInternal::Handle<IntegrityCheckJobI> IntegrityCheckJobIPtr;
    class OMERO_CLIENT IntegrityCheckJobI : virtual public IntegrityCheckJob {
   public:
