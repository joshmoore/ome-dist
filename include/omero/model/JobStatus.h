...
public:
    ...
    ::IceInternal::ProxyHandle<JobStatus> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<JobStatus*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
public:
    ...
    JobStatus(const ::omero::RLongPtr& __ice_id, const ::omero::model::DetailsPtr& __ice_details, bool __ice_loaded, const ::omero::RStringPtr& __ice_value) :
