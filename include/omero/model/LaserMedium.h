...
class Callback_LaserMedium_getValue_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_LaserMedium_getValue_Base> Callback_LaserMedium_getValuePtr;

class Callback_LaserMedium_setValue_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_LaserMedium_setValue_Base> Callback_LaserMedium_setValuePtr;
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_getValue(const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::omero::RStringPtr&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        public:
            ...
            {
                ::omero::model::LaserMediumPrx __proxy = ::omero::model::LaserMediumPrx::uncheckedCast(__result->getProxy());
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getValue(const ::omero::model::Callback_LaserMedium_getValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getValue(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getValue(const ::Ice::Context& __ctx, const ::omero::model::Callback_LaserMedium_getValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getValue(&__ctx, __del, __cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_setValue(const ::omero::RStringPtr& theValue, const ::omero::model::Callback_LaserMedium_setValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setValue(theValue, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setValue(const ::omero::RStringPtr& theValue, const ::Ice::Context& __ctx, const ::omero::model::Callback_LaserMedium_setValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setValue(theValue, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<LaserMedium> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<LaserMedium*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
class LaserMedium : public ::omero::model::IObject
{
public:
    ...
    LaserMedium(const ::omero::RLongPtr& __ice_id, const ::omero::model::DetailsPtr& __ice_details, bool __ice_loaded, const ::omero::RStringPtr& __ice_value) :
...
inline bool operator==(const LaserMedium& l, const LaserMedium& r)
{
...
template<class T>
class CallbackNC_LaserMedium_getValue : public Callback_LaserMedium_getValue_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_LaserMedium_getValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
...
template<class T> Callback_LaserMedium_getValuePtr
newCallback_LaserMedium_getValue(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::omero::RStringPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LaserMedium_getValue<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_LaserMedium_getValuePtr
newCallback_LaserMedium_getValue(T* instance, void (T::*cb)(const ::omero::RStringPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LaserMedium_getValue<T>(instance, cb, excb, sentcb);
}

template<class T, typename CT>
class Callback_LaserMedium_getValue : public Callback_LaserMedium_getValue_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_LaserMedium_getValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
...
template<class T, typename CT> Callback_LaserMedium_getValuePtr
newCallback_LaserMedium_getValue(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::omero::RStringPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LaserMedium_getValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_LaserMedium_getValuePtr
newCallback_LaserMedium_getValue(T* instance, void (T::*cb)(const ::omero::RStringPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LaserMedium_getValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T>
class CallbackNC_LaserMedium_setValue : public Callback_LaserMedium_setValue_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_LaserMedium_setValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};

template<class T> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LaserMedium_setValue<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LaserMedium_setValue<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LaserMedium_setValue<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_LaserMedium_setValue<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_LaserMedium_setValue : public Callback_LaserMedium_setValue_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_LaserMedium_setValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};

template<class T, typename CT> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LaserMedium_setValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LaserMedium_setValue<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LaserMedium_setValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_LaserMedium_setValuePtr
newCallback_LaserMedium_setValue(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_LaserMedium_setValue<T, CT>(instance, 0, excb, sentcb);
}
