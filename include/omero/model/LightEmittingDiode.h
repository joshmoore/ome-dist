...
void __read(::IceInternal::BasicStream*, LightEmittingDiodePrx&);
void __patch__LightEmittingDiodePtr(void*, ::Ice::ObjectPtr&);
...
public:
    ...
    ::IceInternal::ProxyHandle<LightEmittingDiode> ice_context(const ::Ice::Context& __context) const
    {
        ...
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_context(__context).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_adapterId(__id).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_endpoints(__endpoints).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_locatorCacheTimeout(__timeout).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_connectionCached(__cached).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_endpointSelection(__est).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_secure(__secure).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_preferSecure(__preferSecure).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_router(__router).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_locator(__locator).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_collocationOptimized(__co).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_twoway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_oneway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_batchOneway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_datagram().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_batchDatagram().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_compress(__compress).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_timeout(__timeout).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<LightEmittingDiode*>(_Base::ice_connectionId(__id).get());
    #else
...
class LightEmittingDiode : virtual public ::omero::model::LightSource
{
public:
    ...
    LightEmittingDiode() {}
    LightEmittingDiode(const ::omero::RLongPtr&, const ::omero::model::DetailsPtr&, bool, const ::omero::RIntPtr&, const ::omero::RStringPtr&, const ::omero::RStringPtr&, const ::omero::RDoublePtr&, const ::omero::RStringPtr&, const ::omero::RStringPtr&, const ::omero::model::InstrumentPtr&);
