...
namespace omero {
  namespace model {
    class OMERO_API LineI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::LineI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<LineI> LineIPtr;
#endif
    class OMERO_API LineI : virtual public Line {
   public:
