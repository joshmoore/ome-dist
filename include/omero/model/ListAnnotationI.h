   ...
   **
   */
#ifndef LISTANNOTATIONI_H
#define LISTANNOTATIONI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT ListAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::ListAnnotationI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<ListAnnotationI> ListAnnotationIPtr;
#else
  typedef IceUtil::Handle<ListAnnotationI> ListAnnotationIPtr;
#endif
    class OMERO_CLIENT ListAnnotationI : virtual public ListAnnotation {
   public:
    ...
    protected:
      ...
      virtual ~ListAnnotationI();
    public:
      ListAnnotationI();
      ListAnnotationI(omero::RLongPtr idPtr, bool isLoaded = false);
      ListAnnotationI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  ListAnnotation.annotationLinks
      //
