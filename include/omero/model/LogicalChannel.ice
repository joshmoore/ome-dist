...
module omero {
  module model {
    ...
    extends omero::model::IObject
    {
      ...
      omero::RDouble getPinHoleSize();
      void setPinHoleSize(omero::RDouble thePinHoleSize);
      ...
      omero::RInt getExcitationWave();
      void setExcitationWave(omero::RInt theExcitationWave);
      omero::RInt emissionWave;
      omero::RInt getEmissionWave();
      void setEmissionWave(omero::RInt theEmissionWave);
      omero::RString fluor;
