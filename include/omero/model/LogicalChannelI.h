...
namespace omero {
  namespace model {
    class OMERO_API LogicalChannelI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::LogicalChannelI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API LogicalChannelI : virtual public LogicalChannel {
   public:
    ...
    public:
      ...
      virtual omero::RDoublePtr getPinHoleSize(const Ice::Current& current = Ice::Current());
      virtual void setPinHoleSize(const omero::RDoublePtr& _pinHoleSize, const Ice::Current& current = Ice::Current());
      ...
      virtual omero::RIntPtr getExcitationWave(const Ice::Current& current = Ice::Current());
      virtual void setExcitationWave(const omero::RIntPtr& _excitationWave, const Ice::Current& current = Ice::Current());

      //
      //  LogicalChannel.emissionWave
      //
      virtual void unloadEmissionWave();
      virtual omero::RIntPtr getEmissionWave(const Ice::Current& current = Ice::Current());
      virtual void setEmissionWave(const omero::RIntPtr& _emissionWave, const Ice::Current& current = Ice::Current());
