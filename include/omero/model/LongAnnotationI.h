...
namespace omero {
  namespace model {
    class OMERO_CLIENT LongAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::LongAnnotationI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT LongAnnotationI : virtual public LongAnnotation {
   public:
