   ...
   **
   */
#ifndef MAPANNOTATIONI_H
#define MAPANNOTATIONI_H
#include <omero/IceNoWarnPush.h>
#include <omero/RTypes.h>
#include <omero/model/RTypes.h>
#include <omero/model/IObject.h>
#include <omero/model/MapAnnotation.h>
...
namespace omero {
  namespace model {
    class OMERO_CLIENT MapAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::MapAnnotationI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<MapAnnotationI> MapAnnotationIPtr;
#else
  typedef IceUtil::Handle<MapAnnotationI> MapAnnotationIPtr;
#endif
    class OMERO_CLIENT MapAnnotationI : virtual public MapAnnotation {
   public:
      static const std::string MAPVALUE;
    ...
    protected:
      ...
      virtual ~MapAnnotationI();
    public:
      MapAnnotationI();
      MapAnnotationI(omero::RLongPtr idPtr, bool isLoaded = false);
      MapAnnotationI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  MapAnnotation.mapValue
      //
      virtual void unloadMapValue();
      virtual omero::api::NamedValueList getMapValue(const Ice::Current& current = Ice::Current());
      virtual void setMapValue(const omero::api::NamedValueList& _mapValue, const Ice::Current& current = Ice::Current());
      virtual omero::api::StringStringMap getMapValueAsMap(const Ice::Current& current = Ice::Current());
