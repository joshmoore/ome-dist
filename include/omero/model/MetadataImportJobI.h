...
namespace omero {
  namespace model {
    class OMERO_API MetadataImportJobI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::MetadataImportJobI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<MetadataImportJobI> MetadataImportJobIPtr;
#endif
    class OMERO_API MetadataImportJobI : virtual public MetadataImportJob {
   public:
