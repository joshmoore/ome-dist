...
namespace omero {
  namespace model {
    class OMERO_CLIENT NamespaceAnnotationLinkI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::NamespaceAnnotationLinkI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT NamespaceAnnotationLinkI : virtual public NamespaceAnnotationLink {
   public:
