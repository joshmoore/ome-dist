...
namespace omero {
  namespace model {
    class OMERO_CLIENT NodeAnnotationLinkI;
  }
}
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::NodeAnnotationLinkI*);
}
namespace omero {
  namespace model {
  typedef IceInternal::Handle<NodeAnnotationLinkI> NodeAnnotationLinkIPtr;
    class OMERO_CLIENT NodeAnnotationLinkI : virtual public NodeAnnotationLink {
   public:
