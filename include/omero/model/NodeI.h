...
namespace omero {
  namespace model {
    class OMERO_API NodeI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::NodeI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API NodeI : virtual public Node {
   public:
    ...
    public:
      ...
      virtual void addNodeAnnotationLinkToBoth(const NodeAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
