...
namespace omero {
  namespace model {
    class OMERO_CLIENT ObjectiveI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::ObjectiveI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT ObjectiveI : virtual public Objective {
   public:
    ...
    public:
      ...
      virtual omero::model::LengthPtr getWorkingDistance(const Ice::Current& current = Ice::Current());
      virtual void setWorkingDistance(const omero::model::LengthPtr& _workingDistance, const Ice::Current& current = Ice::Current());
    ...
    protected:
      virtual ObjectiveAnnotationLinksSeq getAnnotationLinks(const Ice::Current& current = Ice::Current());
      virtual void setAnnotationLinks(const ObjectiveAnnotationLinksSeq& _annotationLinks, const Ice::Current& current = Ice::Current());
    public:
      virtual bool isAnnotationLinksLoaded();
      virtual Ice::Int sizeOfAnnotationLinks(const Ice::Current& current = Ice::Current());
      virtual ObjectiveAnnotationLinksSeq copyAnnotationLinks(const Ice::Current& current = Ice::Current());
      virtual ObjectiveAnnotationLinksSeq::iterator beginAnnotationLinks();
      virtual ObjectiveAnnotationLinksSeq::iterator endAnnotationLinks();
      virtual void addObjectiveAnnotationLink(const ObjectiveAnnotationLinkPtr& target, const Ice::Current& current = Ice::Current());
      virtual void addAllObjectiveAnnotationLinkSet(const ObjectiveAnnotationLinksSeq& targets, const Ice::Current& current = Ice::Current());
      virtual void removeObjectiveAnnotationLink(const ObjectiveAnnotationLinkPtr& target, const Ice::Current& current = Ice::Current());
      virtual void removeAllObjectiveAnnotationLinkSet(const ObjectiveAnnotationLinksSeq& targets, const Ice::Current& current = Ice::Current());
      virtual void clearAnnotationLinks(const Ice::Current& current = Ice::Current());
      virtual void reloadAnnotationLinks(const ObjectivePtr& toCopy, const Ice::Current& current = Ice::Current());
      virtual omero::sys::CountMap getAnnotationLinksCountPerOwner(const Ice::Current& current = Ice::Current());
      virtual ObjectiveAnnotationLinkPtr linkAnnotation(const AnnotationPtr& addition, const Ice::Current& current = Ice::Current());
      virtual void addObjectiveAnnotationLinkToBoth(const ObjectiveAnnotationLinkPtr& link, bool /*unused*/, const Ice::Current& current = Ice::Current());
      virtual ObjectiveAnnotationLinksSeq findObjectiveAnnotationLink(const AnnotationPtr& removal, const Ice::Current& current = Ice::Current());
      virtual void unlinkAnnotation(const AnnotationPtr& removal, const Ice::Current& current = Ice::Current());
      virtual void removeObjectiveAnnotationLinkFromBoth(const ObjectiveAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
       virtual ObjectiveLinkedAnnotationSeq linkedAnnotationList(const Ice::Current& current = Ice::Current());
 };
