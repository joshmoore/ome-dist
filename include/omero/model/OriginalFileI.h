  ...
  typedef IceInternal::Handle<OriginalFileI> OriginalFileIPtr;
   ...
   public:
    ...
    public:
      ...
      //  OriginalFile.repo
      //
      virtual void unloadRepo();
      virtual omero::RStringPtr getRepo(const Ice::Current& current = Ice::Current());
      virtual void setRepo(const omero::RStringPtr& _repo, const Ice::Current& current = Ice::Current());
