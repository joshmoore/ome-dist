   ...
   **
   */
#ifndef PIXELDATAJOBI_H
#define PIXELDATAJOBI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT PixelDataJobI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::PixelDataJobI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<PixelDataJobI> PixelDataJobIPtr;
#else
  typedef IceUtil::Handle<PixelDataJobI> PixelDataJobIPtr;
#endif
    class OMERO_CLIENT PixelDataJobI : virtual public PixelDataJob {
   public:
    ...
    protected:
      ...
      virtual ~PixelDataJobI();
    public:
      PixelDataJobI();
      PixelDataJobI(omero::RLongPtr idPtr, bool isLoaded = false);
      PixelDataJobI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  PixelDataJob.originalFileLinks
      //
