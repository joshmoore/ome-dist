...
namespace omero {
  namespace model {
    class OMERO_API PlaneInfoI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::PlaneInfoI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API PlaneInfoI : virtual public PlaneInfo {
   public:
    ...
    public:
      ...
      virtual omero::RDoublePtr getDeltaT(const Ice::Current& current = Ice::Current());
      virtual void setDeltaT(const omero::RDoublePtr& _deltaT, const Ice::Current& current = Ice::Current());
      ...
      virtual omero::RDoublePtr getExposureTime(const Ice::Current& current = Ice::Current());
      virtual void setExposureTime(const omero::RDoublePtr& _exposureTime, const Ice::Current& current = Ice::Current());
    ...
    public:
      ...
      virtual void addPlaneInfoAnnotationLinkToBoth(const PlaneInfoAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
