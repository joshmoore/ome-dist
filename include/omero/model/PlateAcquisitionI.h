...
namespace omero {
  namespace model {
    class OMERO_API PlateAcquisitionI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::PlateAcquisitionI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<PlateAcquisitionI> PlateAcquisitionIPtr;
#endif
    class OMERO_API PlateAcquisitionI : virtual public PlateAcquisition {
   public:
    ...
    public:
      ...
      virtual void addPlateAcquisitionAnnotationLinkToBoth(const PlateAcquisitionAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
