...
namespace omero {
  namespace model {
    class OMERO_API PlateAnnotationLinkI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::PlateAnnotationLinkI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API PlateAnnotationLinkI : virtual public PlateAnnotationLink {
   public:
