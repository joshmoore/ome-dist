...
class Polyline;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::omero::model::Polyline>&);
...
void __patch(PolylinePtr&, const ::Ice::ObjectPtr&);
...
class Callback_Polyline_getPoints_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Polyline_getPoints_Base> Callback_Polyline_getPointsPtr;

class Callback_Polyline_setPoints_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Polyline_setPoints_Base> Callback_Polyline_setPointsPtr;

class Callback_Polyline_getTextValue_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Polyline_getTextValue_Base> Callback_Polyline_getTextValuePtr;

class Callback_Polyline_setTextValue_Base : virtual public ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_Polyline_setTextValue_Base> Callback_Polyline_setTextValuePtr;
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_getPoints(const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::omero::RStringPtr&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        public:
            ...
            {
                ::omero::model::PolylinePrx __proxy = ::omero::model::PolylinePrx::uncheckedCast(__result->getProxy());
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getPoints(const ::omero::model::Callback_Polyline_getPointsPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getPoints(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getPoints(const ::Ice::Context& __ctx, const ::omero::model::Callback_Polyline_getPointsPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getPoints(&__ctx, __del, __cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_setPoints(const ::omero::RStringPtr& thePoints, const ::omero::model::Callback_Polyline_setPointsPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPoints(thePoints, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setPoints(const ::omero::RStringPtr& thePoints, const ::Ice::Context& __ctx, const ::omero::model::Callback_Polyline_setPointsPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setPoints(thePoints, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getTextValue(const ::omero::model::Callback_Polyline_getTextValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getTextValue(0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_getTextValue(const ::Ice::Context& __ctx, const ::omero::model::Callback_Polyline_getTextValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_getTextValue(&__ctx, __del, __cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_setTextValue(const ::omero::RStringPtr& theTextValue, const ::omero::model::Callback_Polyline_setTextValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setTextValue(theTextValue, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setTextValue(const ::omero::RStringPtr& theTextValue, const ::Ice::Context& __ctx, const ::omero::model::Callback_Polyline_setTextValuePtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setTextValue(theTextValue, &__ctx, __del, __cookie);
    }
...
public:
    ...
    ::IceInternal::ProxyHandle<Polyline> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<Polyline*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
class Polyline : public ::omero::model::Shape
{
public:
...
inline bool operator==(const Polyline& l, const Polyline& r)
{
...
template<class T>
class CallbackNC_Polyline_getPoints : public Callback_Polyline_getPoints_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_Polyline_getPoints(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
...
template<class T> Callback_Polyline_getPointsPtr
newCallback_Polyline_getPoints(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::omero::RStringPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_getPoints<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Polyline_getPointsPtr
newCallback_Polyline_getPoints(T* instance, void (T::*cb)(const ::omero::RStringPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_getPoints<T>(instance, cb, excb, sentcb);
}

template<class T, typename CT>
class Callback_Polyline_getPoints : public Callback_Polyline_getPoints_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_Polyline_getPoints(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
...
template<class T, typename CT> Callback_Polyline_getPointsPtr
newCallback_Polyline_getPoints(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::omero::RStringPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_getPoints<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_getPointsPtr
newCallback_Polyline_getPoints(T* instance, void (T::*cb)(const ::omero::RStringPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_getPoints<T, CT>(instance, cb, excb, sentcb);
}

template<class T>
class CallbackNC_Polyline_setPoints : public Callback_Polyline_setPoints_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_Polyline_setPoints(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};

template<class T> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setPoints<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setPoints<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setPoints<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setPoints<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_Polyline_setPoints : public Callback_Polyline_setPoints_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_Polyline_setPoints(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};

template<class T, typename CT> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setPoints<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setPoints<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setPoints<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_setPointsPtr
newCallback_Polyline_setPoints(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setPoints<T, CT>(instance, 0, excb, sentcb);
}

template<class T>
class CallbackNC_Polyline_getTextValue : public Callback_Polyline_getTextValue_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    CallbackNC_Polyline_getTextValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), response(cb)
    {
    }
...
template<class T> Callback_Polyline_getTextValuePtr
newCallback_Polyline_getTextValue(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::omero::RStringPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_getTextValue<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Polyline_getTextValuePtr
newCallback_Polyline_getTextValue(T* instance, void (T::*cb)(const ::omero::RStringPtr&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_getTextValue<T>(instance, cb, excb, sentcb);
}

template<class T, typename CT>
class Callback_Polyline_getTextValue : public Callback_Polyline_getTextValue_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    Callback_Polyline_getTextValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), response(cb)
    {
    }
...
template<class T, typename CT> Callback_Polyline_getTextValuePtr
newCallback_Polyline_getTextValue(const IceUtil::Handle<T>& instance, void (T::*cb)(const ::omero::RStringPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_getTextValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_getTextValuePtr
newCallback_Polyline_getTextValue(T* instance, void (T::*cb)(const ::omero::RStringPtr&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_getTextValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T>
class CallbackNC_Polyline_setTextValue : public Callback_Polyline_setTextValue_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_Polyline_setTextValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};

template<class T> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setTextValue<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setTextValue<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setTextValue<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_Polyline_setTextValue<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_Polyline_setTextValue : public Callback_Polyline_setTextValue_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_Polyline_setTextValue(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};

template<class T, typename CT> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setTextValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setTextValue<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setTextValue<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_Polyline_setTextValuePtr
newCallback_Polyline_setTextValue(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_Polyline_setTextValue<T, CT>(instance, 0, excb, sentcb);
}
