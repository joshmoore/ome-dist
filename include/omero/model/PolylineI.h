...
namespace omero {
  namespace model {
    class OMERO_CLIENT PolylineI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::PolylineI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT PolylineI : virtual public Polyline {
   public:
