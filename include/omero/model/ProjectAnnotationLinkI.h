...
namespace omero {
  namespace model {
    class OMERO_API ProjectAnnotationLinkI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ProjectAnnotationLinkI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API ProjectAnnotationLinkI : virtual public ProjectAnnotationLink {
   public:
