...
namespace omero {
  namespace model {
    class OMERO_API ReagentAnnotationLinkI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ReagentAnnotationLinkI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API ReagentAnnotationLinkI : virtual public ReagentAnnotationLink {
   public:
