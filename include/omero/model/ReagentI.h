...
namespace omero {
  namespace model {
    class OMERO_API ReagentI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ReagentI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<ReagentI> ReagentIPtr;
#endif
    class OMERO_API ReagentI : virtual public Reagent {
   public:
    ...
    public:
      ...
      virtual void addReagentAnnotationLinkToBoth(const ReagentAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
