...
namespace omero {
  namespace model {
    class OMERO_CLIENT TagAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::TagAnnotationI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_CLIENT TagAnnotationI : virtual public TagAnnotation {
   public:
