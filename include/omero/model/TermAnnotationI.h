   ...
   **
   */
#ifndef TERMANNOTATIONI_H
#define TERMANNOTATIONI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT TermAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::TermAnnotationI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<TermAnnotationI> TermAnnotationIPtr;
#else
  typedef IceUtil::Handle<TermAnnotationI> TermAnnotationIPtr;
#endif
    class OMERO_CLIENT TermAnnotationI : virtual public TermAnnotation {
   public:
      static const std::string TERMVALUE;
    ...
    protected:
      ...
      virtual ~TermAnnotationI();
    public:
      TermAnnotationI();
      TermAnnotationI(omero::RLongPtr idPtr, bool isLoaded = false);
      TermAnnotationI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  TermAnnotation.termValue
      //
      virtual void unloadTermValue();
      virtual omero::RStringPtr getTermValue(const Ice::Current& current = Ice::Current());
      virtual void setTermValue(const omero::RStringPtr& _termValue, const Ice::Current& current = Ice::Current());
      ...
      //
      //  TermAnnotation.annotationLinks
      //
