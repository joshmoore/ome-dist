...
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::omero::model::ThumbnailGenerationJob>&);
...
void __patch(ThumbnailGenerationJobPtr&, const ::Ice::ObjectPtr&);
...
public:
    ...
    ::IceInternal::ProxyHandle<ThumbnailGenerationJob> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<ThumbnailGenerationJob*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
class ThumbnailGenerationJob : public ::omero::model::Job
{
public:
...
inline bool operator==(const ThumbnailGenerationJob& l, const ThumbnailGenerationJob& r)
{
