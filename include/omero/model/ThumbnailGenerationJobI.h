   ...
   **
   */
#ifndef THUMBNAILGENERATIONJOBI_H
#define THUMBNAILGENERATIONJOBI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT ThumbnailGenerationJobI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::ThumbnailGenerationJobI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<ThumbnailGenerationJobI> ThumbnailGenerationJobIPtr;
#else
  typedef IceUtil::Handle<ThumbnailGenerationJobI> ThumbnailGenerationJobIPtr;
#endif
    class OMERO_CLIENT ThumbnailGenerationJobI : virtual public ThumbnailGenerationJob {
   public:
    ...
    protected:
      ...
      virtual ~ThumbnailGenerationJobI();
    public:
      ThumbnailGenerationJobI();
      ThumbnailGenerationJobI(omero::RLongPtr idPtr, bool isLoaded = false);
      ThumbnailGenerationJobI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  ThumbnailGenerationJob.username
      //
      ...
      //
      //  ThumbnailGenerationJob.groupname
      //
      ...
      //
      //  ThumbnailGenerationJob.message
      //
      ...
      //
      //  ThumbnailGenerationJob.submitted
      //
      ...
      //
      //  ThumbnailGenerationJob.scheduledFor
      //
      ...
      //
      //  ThumbnailGenerationJob.started
      //
      ...
      //
      //  ThumbnailGenerationJob.finished
      //
      ...
      //
      //  ThumbnailGenerationJob.originalFileLinks
      //
...
#endif // THUMBNAILGENERATIONJOBI_H
