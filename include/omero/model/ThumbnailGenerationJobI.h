...
namespace omero {
  namespace model {
    class OMERO_API ThumbnailGenerationJobI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::ThumbnailGenerationJobI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API ThumbnailGenerationJobI : virtual public ThumbnailGenerationJob {
   public:
