...
namespace omero {
  namespace model {
    class OMERO_API TimestampAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::TimestampAnnotationI*);
}
#endif
namespace omero {
  namespace model {
...
#endif
    class OMERO_API TimestampAnnotationI : virtual public TimestampAnnotation {
   public:
