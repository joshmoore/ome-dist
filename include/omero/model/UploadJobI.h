...
namespace omero {
  namespace model {
    class OMERO_API UploadJobI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::UploadJobI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<UploadJobI> UploadJobIPtr;
#else
  typedef IceUtil::Handle<UploadJobI> UploadJobIPtr;
#endif
    class OMERO_API UploadJobI : virtual public UploadJob {
   public:
    ...
    public:
      UploadJobI();
      UploadJobI(omero::RLongPtr idPtr, bool isLoaded = false);
      UploadJobI(Ice::Long id, bool isLoaded = false);
      ...
      //
      //  UploadJob.versionInfo
      //
      virtual void unloadVersionInfo();
      virtual omero::model::FilesetVersionInfoPtr getVersionInfo(const Ice::Current& current = Ice::Current());
      virtual void setVersionInfo(const omero::model::FilesetVersionInfoPtr& _versionInfo, const Ice::Current& current = Ice::Current());
