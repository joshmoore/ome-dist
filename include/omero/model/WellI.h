...
namespace omero {
  namespace model {
    class OMERO_API WellI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_API ::Ice::Object* upCast(::omero::model::WellI*);
}
#endif
namespace omero {
  namespace model {
...
#else
  typedef IceUtil::Handle<WellI> WellIPtr;
#endif
    class OMERO_API WellI : virtual public Well {
   public:
    ...
    public:
      ...
      virtual void addWellAnnotationLinkToBoth(const WellAnnotationLinkPtr& link, bool bothSides, const Ice::Current& current = Ice::Current());
