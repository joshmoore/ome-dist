...
class XmlAnnotation;
void __read(::IceInternal::BasicStream*, ::IceInternal::ProxyHandle< ::IceProxy::omero::model::XmlAnnotation>&);
...
void __patch(XmlAnnotationPtr&, const ::Ice::ObjectPtr&);
...
public:
    ...
    ::IceInternal::ProxyHandle<XmlAnnotation> ice_encodingVersion(const ::Ice::EncodingVersion& __v) const
    {
        return dynamic_cast<XmlAnnotation*>(::IceProxy::Ice::Object::ice_encodingVersion(__v).get());
    }
...
class XmlAnnotation : public ::omero::model::TextAnnotation
{
public:
...
inline bool operator==(const XmlAnnotation& l, const XmlAnnotation& r)
{
