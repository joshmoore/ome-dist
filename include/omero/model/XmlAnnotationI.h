   ...
   **
   */
#ifndef XMLANNOTATIONI_H
#define XMLANNOTATIONI_H
...
namespace omero {
  namespace model {
    class OMERO_CLIENT XmlAnnotationI;
  }
}
#if ICE_INT_VERSION / 100 >= 304
namespace IceInternal {
  OMERO_CLIENT ::Ice::Object* upCast(::omero::model::XmlAnnotationI*);
}
#endif
namespace omero {
  namespace model {
#if ICE_INT_VERSION / 100 >= 304
  typedef IceInternal::Handle<XmlAnnotationI> XmlAnnotationIPtr;
#else
  typedef IceUtil::Handle<XmlAnnotationI> XmlAnnotationIPtr;
#endif
    class OMERO_CLIENT XmlAnnotationI : virtual public XmlAnnotation {
   public:
    ...
    protected:
      ...
      virtual ~XmlAnnotationI();
    public:
      XmlAnnotationI();
      XmlAnnotationI(omero::RLongPtr idPtr, bool isLoaded = false);
      XmlAnnotationI(Ice::Long id, bool isLoaded = false);
