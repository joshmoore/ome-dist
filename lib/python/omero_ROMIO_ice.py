...
if not _M_omero.romio.__dict__.has_key('PlaneDefWithMasks'):
...
height equal to those of the image.'''
    ...
    _M_omero.romio._t_PlaneDefWithMasks = IcePy.defineClass('::omero::romio::PlaneDefWithMasks', PlaneDefWithMasks, (), False, _M_omero.romio._t_PlaneDef, (), (('shapeIds', (), _M_omero.api._t_LongList),))
