...
Returns the IDs of the original files whose checksums
do not match the file on disk.'''
        def verifyChecksums_async(self, _cb, ids, _ctx=None):
            return _M_omero.grid.ManagedRepository._op_verifyChecksums.invokeAsync(self, (_cb, (ids, ), _ctx))
...
Returns the IDs of the original files that did not already
have a checksum set for the given algorithm.'''
        def setChecksumAlgorithm_async(self, _cb, hasher, ids, _ctx=None):
            return _M_omero.grid.ManagedRepository._op_setChecksumAlgorithm.invokeAsync(self, (_cb, (hasher, ids), _ctx))
    ...
    ManagedRepository._op_verifyChecksums = IcePy.Operation('verifyChecksums', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.api._t_LongList),), (), _M_omero.api._t_LongList, (_M_omero._t_ServerError,))
    ManagedRepository._op_setChecksumAlgorithm = IcePy.Operation('setChecksumAlgorithm', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_ChecksumAlgorithm), ((), _M_omero.api._t_LongList)), (), _M_omero.api._t_LongList, (_M_omero._t_ServerError,))
