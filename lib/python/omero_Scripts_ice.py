...
throw an exception so that it can be called oneway.'''
    ...
    Process._op_poll = IcePy.Operation('poll', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero._t_RInt, (_M_omero._t_ServerError,))
    Process._op_wait = IcePy.Operation('wait', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), IcePy._t_int, (_M_omero._t_ServerError,))
    Process._op_cancel = IcePy.Operation('cancel', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), IcePy._t_bool, (_M_omero._t_ServerError,))
...
(stdout, stderr, ...) will be uploaded.'''
    ...
    ScriptProcess._op_getJob = IcePy.Operation('getJob', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.model._t_ScriptJob, (_M_omero._t_ServerError,))
    ScriptProcess._op_getResults = IcePy.Operation('getResults', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_int),), (), _M_omero._t_RTypeDict, (_M_omero._t_ServerError,))
    ScriptProcess._op_setMessage = IcePy.Operation('setMessage', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_string),), (), IcePy._t_string, (_M_omero._t_ServerError,))
...
to query whether or not a processor will accept a certain operation.'''
    ...
    ProcessorCallback._op_isAccepted = IcePy.Operation('isAccepted', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_bool), ((), IcePy._t_string), ((), IcePy._t_string)), (), None, ())
    ProcessorCallback._op_isProxyAccepted = IcePy.Operation('isProxyAccepted', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_bool), ((), IcePy._t_string), ((), _M_omero.grid._t_ProcessorPrx)), (), None, ())
    ProcessorCallback._op_responseRunning = IcePy.Operation('responseRunning', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.api._t_LongList),), (), None, ())
...
was created by a previously call to [parseJob].'''
    ...
    Processor._op_willAccept = IcePy.Operation('willAccept', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.model._t_Experimenter), ((), _M_omero.model._t_ExperimenterGroup), ((), _M_omero.model._t_Job), ((), _M_omero.grid._t_ProcessorCallbackPrx)), (), None, ())
    Processor._op_requestRunning = IcePy.Operation('requestRunning', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.grid._t_ProcessorCallbackPrx),), (), None, ())
    Processor._op_parseJob = IcePy.Operation('parseJob', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_string), ((), _M_omero.model._t_Job)), (), _M_omero.grid._t_JobParams, (_M_omero._t_ServerError,))
...
if detach is set to false.'''
    ...
    InteractiveProcessor._op_expires = IcePy.Operation('expires', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), IcePy._t_long, ())
    InteractiveProcessor._op_getJob = IcePy.Operation('getJob', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.model._t_Job, ())
    InteractiveProcessor._op_params = IcePy.Operation('params', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.grid._t_JobParams, (_M_omero._t_ServerError,))
    ...
    InteractiveProcessor._op_getResults = IcePy.Operation('getResults', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.grid._t_ProcessPrx),), (), _M_omero._t_RMap, (_M_omero._t_ServerError,))
    InteractiveProcessor._op_setDetach = IcePy.Operation('setDetach', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_bool),), (), IcePy._t_bool, (_M_omero._t_ServerError,))
    InteractiveProcessor._op_stop = IcePy.Operation('stop', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), None, (_M_omero._t_ServerError,))
