...
a new instance.'''
    ...
    SharedResources._op_repositories = IcePy.Operation('repositories', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.grid._t_RepositoryMap, (_M_omero._t_ServerError,))
    SharedResources._op_getScriptRepository = IcePy.Operation('getScriptRepository', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.grid._t_RepositoryPrx, (_M_omero._t_ServerError,))
    SharedResources._op_areTablesEnabled = IcePy.Operation('areTablesEnabled', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), IcePy._t_bool, (_M_omero._t_ServerError,))
    ...
    SharedResources._op_openTable = IcePy.Operation('openTable', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.model._t_OriginalFile),), (), _M_omero.grid._t_TablePrx, (_M_omero._t_ServerError,))
