...
will be thrown if the data has since been modified.'''
    ...
    Table._op_getOriginalFile = IcePy.Operation('getOriginalFile', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.model._t_OriginalFile, (_M_omero._t_ServerError,))
    Table._op_getHeaders = IcePy.Operation('getHeaders', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.grid._t_ColumnArray, (_M_omero._t_ServerError,))
    Table._op_getNumberOfRows = IcePy.Operation('getNumberOfRows', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), IcePy._t_long, (_M_omero._t_ServerError,))
    Table._op_getWhereList = IcePy.Operation('getWhereList', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_string), ((), _M_omero._t_RTypeDict), ((), IcePy._t_long), ((), IcePy._t_long), ((), IcePy._t_long)), (), _M_omero.api._t_LongArray, (_M_omero._t_ServerError,))
    Table._op_readCoordinates = IcePy.Operation('readCoordinates', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.api._t_LongArray),), (), _M_omero.grid._t_Data, (_M_omero._t_ServerError,))
    Table._op_read = IcePy.Operation('read', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.api._t_LongArray), ((), IcePy._t_long), ((), IcePy._t_long)), (), _M_omero.grid._t_Data, (_M_omero._t_ServerError,))
    Table._op_slice = IcePy.Operation('slice', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.api._t_LongArray), ((), _M_omero.api._t_LongArray)), (), _M_omero.grid._t_Data, (_M_omero._t_ServerError,))
    ...
    Table._op_getAllMetadata = IcePy.Operation('getAllMetadata', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero._t_RTypeDict, (_M_omero._t_ServerError,))
    Table._op_getMetadata = IcePy.Operation('getMetadata', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_string),), (), _M_omero._t_RType, (_M_omero._t_ServerError,))
    Table._op_setAllMetadata = IcePy.Operation('setAllMetadata', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero._t_RTypeDict),), (), None, (_M_omero._t_ServerError,))
    Table._op_setMetadata = IcePy.Operation('setMetadata', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), IcePy._t_string), ((), _M_omero._t_RType)), (), None, (_M_omero._t_ServerError,))
...
via services in the [omero::api::ServiceFactory].'''
    ...
    Tables._op_getRepository = IcePy.Operation('getRepository', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (), (), _M_omero.grid._t_RepositoryPrx, (_M_omero._t_ServerError,))
    Tables._op_getTable = IcePy.Operation('getTable', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, (), (((), _M_omero.model._t_OriginalFile), ((), _M_omero.api._t_ServiceFactoryPrx)), (), _M_omero.grid._t_TablePrx, (_M_omero._t_ServerError,))
