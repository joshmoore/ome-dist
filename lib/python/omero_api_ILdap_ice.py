...
if not _M_omero.api.__dict__.has_key('ILdap'):
    ...
    class ILdapPrx(_M_omero.api.ServiceInterfacePrx):
        ...
        def findGroupDN_async(self, _cb, groupname, _ctx=None):
            return _M_omero.api.ILdap._op_findGroupDN.invokeAsync(self, (_cb, (groupname, ), _ctx))
        ...
        def findGroup_async(self, _cb, groupname, _ctx=None):
            return _M_omero.api.ILdap._op_findGroup.invokeAsync(self, (_cb, (groupname, ), _ctx))
        ...
        def discover_async(self, _cb, _ctx=None):
            return _M_omero.api.ILdap._op_discover.invokeAsync(self, (_cb, (), _ctx))
        ...
        def discoverGroups_async(self, _cb, _ctx=None):
            return _M_omero.api.ILdap._op_discoverGroups.invokeAsync(self, (_cb, (), _ctx))
    ...
    ILdap._op_findGroupDN = IcePy.Operation('findGroupDN', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string),), (), IcePy._t_string, (_M_omero._t_ServerError,))
    ...
    ILdap._op_findGroup = IcePy.Operation('findGroup', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_string),), (), _M_omero.model._t_ExperimenterGroup, (_M_omero._t_ServerError,))
    ...
    ILdap._op_discover = IcePy.Operation('discover', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_omero.api._t_ExperimenterList, (_M_omero._t_ServerError,))
    ILdap._op_discoverGroups = IcePy.Operation('discoverGroups', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_omero.api._t_ExperimenterGroupList, (_M_omero._t_ServerError,))
