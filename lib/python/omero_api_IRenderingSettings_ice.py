...
if not _M_omero.api.__dict__.has_key('IRenderingSettings'):
    ...
    IRenderingSettings._op_sanityCheckPixels = IcePy.Operation('sanityCheckPixels', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.model._t_Pixels), ((), _M_omero.model._t_Pixels)), (), IcePy._t_bool, (_M_omero._t_ServerError,))
    IRenderingSettings._op_getRenderingSettings = IcePy.Operation('getRenderingSettings', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_long),), (), _M_omero.model._t_RenderingDef, (_M_omero._t_ServerError,))
