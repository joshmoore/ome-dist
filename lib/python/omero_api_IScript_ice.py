...
A valid script will be returned if it exists; otherwise null.'''
    ...
    IScript._op_canRunScript = IcePy.Operation('canRunScript', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_long),), (), IcePy._t_bool, (_M_omero._t_ServerError,))
    IScript._op_validateScript = IcePy.Operation('validateScript', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.model._t_Job), ((), _M_omero.api._t_IObjectList)), (), _M_omero.model._t_OriginalFile, (_M_omero._t_ServerError,))
