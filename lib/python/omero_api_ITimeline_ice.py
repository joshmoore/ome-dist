...
eventLog.getId() == null) for "Image acquisitions".'''
    ...
    ITimeline._op_getMostRecentAnnotationLinks = IcePy.Operation('getMostRecentAnnotationLinks', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.api._t_StringSet), ((), _M_omero.api._t_StringSet), ((), _M_omero.api._t_StringSet), ((), _M_omero.sys._t_Parameters)), (), _M_omero.api._t_IObjectList, (_M_omero._t_ServerError,))
    ITimeline._op_getMostRecentShareCommentLinks = IcePy.Operation('getMostRecentShareCommentLinks', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.sys._t_Parameters),), (), _M_omero.api._t_IObjectList, (_M_omero._t_ServerError,))
    ITimeline._op_getMostRecentObjects = IcePy.Operation('getMostRecentObjects', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.api._t_StringSet), ((), _M_omero.sys._t_Parameters), ((), IcePy._t_bool)), (), _M_omero.api._t_IObjectListMap, (_M_omero._t_ServerError,))
    ITimeline._op_getByPeriod = IcePy.Operation('getByPeriod', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.api._t_StringSet), ((), _M_omero._t_RTime), ((), _M_omero._t_RTime), ((), _M_omero.sys._t_Parameters), ((), IcePy._t_bool)), (), _M_omero.api._t_IObjectListMap, (_M_omero._t_ServerError,))
    ITimeline._op_countByPeriod = IcePy.Operation('countByPeriod', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.api._t_StringSet), ((), _M_omero._t_RTime), ((), _M_omero._t_RTime), ((), _M_omero.sys._t_Parameters)), (), _M_omero.api._t_StringLongMap, (_M_omero._t_ServerError,))
    ITimeline._op_getEventLogsByPeriod = IcePy.Operation('getEventLogsByPeriod', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero._t_RTime), ((), _M_omero._t_RTime), ((), _M_omero.sys._t_Parameters)), (), _M_omero.api._t_EventLogList, (_M_omero._t_ServerError,))
