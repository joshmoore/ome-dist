...
if not _M_omero.api.__dict__.has_key('ITypes'):
    ...
    ITypes._op_getOriginalEnumerations = IcePy.Operation('getOriginalEnumerations', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (), (), _M_omero.api._t_IObjectList, (_M_omero._t_ServerError,))
