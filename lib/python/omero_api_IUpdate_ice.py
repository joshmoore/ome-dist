...
if not _M_omero.api.__dict__.has_key('IUpdate'):
    ...
    IUpdate._op_indexObject = IcePy.Operation('indexObject', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), _M_omero.model._t_IObject),), (), None, (_M_omero._t_ServerError,))
