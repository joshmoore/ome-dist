...
if not _M_omero.api.__dict__.has_key('MetadataStore'):
    ...
    class MetadataStorePrx(_M_omero.api.StatefulServiceInterfacePrx):
        ...
        def begin_setPixelsParams(self, pixelsId, useOriginalFile, params, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_omero.api.MetadataStore._op_setPixelsParams.begin(self, ((pixelsId, useOriginalFile, params), _response, _ex, _sent, _ctx))

        def end_setPixelsParams(self, _r):
            return _M_omero.api.MetadataStore._op_setPixelsParams.end(self, _r)
