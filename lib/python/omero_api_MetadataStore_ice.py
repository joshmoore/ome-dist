...
_M_omero.metadatastore.__doc__ = '''Types used during import.'''
...
if not _M_omero.api.__dict__.has_key('MetadataStore'):
    ...
    class MetadataStorePrx(_M_omero.api.StatefulServiceInterfacePrx):
        ...
        def setPixelsFile_async(self, _cb, pixelsId, file, repo, _ctx=None):
            return _M_omero.api.MetadataStore._op_setPixelsFile.invokeAsync(self, (_cb, (pixelsId, file, repo), _ctx))
    ...
    MetadataStore._op_setPixelsFile = IcePy.Operation('setPixelsFile', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, True, (), (((), IcePy._t_long), ((), IcePy._t_string), ((), IcePy._t_string)), (), None, (_M_omero._t_ServerError,))
