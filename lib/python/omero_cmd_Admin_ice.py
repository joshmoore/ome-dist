...
if not _M_omero.cmd.__dict__.has_key('UpdateSessionTimeoutRequest'):
...
an [omero::cmd::OK] counts as success.'''
    ...
    _M_omero.cmd._t_UpdateSessionTimeoutRequest = IcePy.defineClass('::omero::cmd::UpdateSessionTimeoutRequest', UpdateSessionTimeoutRequest, (), False, _M_omero.cmd._t_Request, (), (
        ('session', (), IcePy._t_string),
        ('timeToLive', (), _M_omero._t_RLong),
        ('timeToIdle', (), _M_omero._t_RLong)
    ))
...
if not _M_omero.cmd.__dict__.has_key('CurrentSessionsRequest'):
...
[CurrentSessionsResponse] if no [omero::cmd::ERR] occurs.'''
    ...
    _M_omero.cmd._t_CurrentSessionsRequest = IcePy.defineClass('::omero::cmd::CurrentSessionsRequest', CurrentSessionsRequest, (), False, _M_omero.cmd._t_Request, (), ())
...
if not _M_omero.cmd.__dict__.has_key('CurrentSessionsResponse'):
...
those belonging to that user will be nulled.'''
    ...
    _M_omero.cmd._t_CurrentSessionsResponse = IcePy.defineClass('::omero::cmd::CurrentSessionsResponse', CurrentSessionsResponse, (), False, _M_omero.cmd._t_Response, (), (
        ('sessions', (), _M_omero.api._t_SessionList),
        ('contexts', (), _M_omero.api._t_EventContextList),
        ('data', (), _M_omero.api._t_RTypeDictArray)
    ))
