...
if not _M_omero.cmd.__dict__.has_key('DoAll'):
    ...
    _M_omero.cmd._t_DoAll = IcePy.defineClass('::omero::cmd::DoAll', DoAll, (), False, _M_omero.cmd._t_Request, (), (
        ('requests', (), _M_omero.cmd._t_RequestList),
        ('contexts', (), _M_omero.cmd._t_StringMapList)
    ))
    DoAll.ice_type = _M_omero.cmd._t_DoAll
...
if not _M_omero.cmd.__dict__.has_key('DoAllRsp'):
    ...
    _M_omero.cmd._t_DoAllRsp = IcePy.defineClass('::omero::cmd::DoAllRsp', DoAllRsp, (), False, _M_omero.cmd._t_OK, (), (
        ('responses', (), _M_omero.cmd._t_ResponseList),
        ('status', (), _M_omero.cmd._t_StatusList)
    ))
    DoAllRsp.ice_type = _M_omero.cmd._t_DoAllRsp
...
if not _M_omero.cmd.__dict__.has_key('ListRequests'):
    ...
    _M_omero.cmd._t_ListRequests = IcePy.defineClass('::omero::cmd::ListRequests', ListRequests, (), False, _M_omero.cmd._t_Request, (), ())
    ListRequests.ice_type = _M_omero.cmd._t_ListRequests
...
if not _M_omero.cmd.__dict__.has_key('ListRequestsRsp'):
    ...
    _M_omero.cmd._t_ListRequestsRsp = IcePy.defineClass('::omero::cmd::ListRequestsRsp', ListRequestsRsp, (), False, _M_omero.cmd._t_OK, (), (('list', (), _M_omero.cmd._t_RequestList),))
    ListRequestsRsp.ice_type = _M_omero.cmd._t_ListRequestsRsp
...
if not _M_omero.cmd.__dict__.has_key('PopStatus'):
    ...
    _M_omero.cmd._t_PopStatus = IcePy.defineClass('::omero::cmd::PopStatus', PopStatus, (), False, _M_omero.cmd._t_Request, (), (
        ('limit', (), IcePy._t_int),
        ('include', (), _M_omero.cmd._t_StateList),
        ('exclude', (), _M_omero.cmd._t_StateList)
    ))
    PopStatus.ice_type = _M_omero.cmd._t_PopStatus
...
if not _M_omero.cmd.__dict__.has_key('PopStatusRsp'):
    ...
    _M_omero.cmd._t_PopStatusRsp = IcePy.defineClass('::omero::cmd::PopStatusRsp', PopStatusRsp, (), False, _M_omero.cmd._t_OK, (), (('list', (), _M_omero.cmd._t_StatusList),))
    PopStatusRsp.ice_type = _M_omero.cmd._t_PopStatusRsp
...
if not _M_omero.cmd.__dict__.has_key('FindHandles'):
    ...
    _M_omero.cmd._t_FindHandles = IcePy.defineClass('::omero::cmd::FindHandles', FindHandles, (), False, _M_omero.cmd._t_Request, (), (
        ('limit', (), IcePy._t_int),
        ('include', (), _M_omero.cmd._t_StateList),
        ('exclude', (), _M_omero.cmd._t_StateList)
    ))
    FindHandles.ice_type = _M_omero.cmd._t_FindHandles
...
if not _M_omero.cmd.__dict__.has_key('FindHandlesRsp'):
    ...
    _M_omero.cmd._t_FindHandlesRsp = IcePy.defineClass('::omero::cmd::FindHandlesRsp', FindHandlesRsp, (), False, _M_omero.cmd._t_OK, (), (('handles', (), _M_omero.cmd._t_HandleList),))
    FindHandlesRsp.ice_type = _M_omero.cmd._t_FindHandlesRsp
...
if not _M_omero.cmd.__dict__.has_key('Timing'):
    ...
    _M_omero.cmd._t_Timing = IcePy.defineClass('::omero::cmd::Timing', Timing, (), False, _M_omero.cmd._t_Request, (), (
        ('steps', (), IcePy._t_int),
        ('millisPerStep', (), IcePy._t_int)
    ))
    Timing.ice_type = _M_omero.cmd._t_Timing
