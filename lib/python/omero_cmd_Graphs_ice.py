...
if not _M_omero.cmd.graphs.__dict__.has_key('ChildOption'):
...
No more than one of includeNs and excludeNs may be used.'''
    ...
    _M_omero.cmd.graphs._t_ChildOption = IcePy.defineClass('::omero::cmd::graphs::ChildOption', ChildOption, (), False, None, (), (
        ('includeType', (), _M_omero.api._t_StringSet),
        ('excludeType', (), _M_omero.api._t_StringSet),
        ('includeNs', (), _M_omero.api._t_StringSet),
        ('excludeNs', (), _M_omero.api._t_StringSet)
    ))
...
if not _M_omero.cmd.graphs.__dict__.has_key('_t_ChildOptions'):
...
if not _M_omero.cmd.__dict__.has_key('GraphModify2'):
...
graph.'''
    ...
    _M_omero.cmd._t_GraphModify2 = IcePy.defineClass('::omero::cmd::GraphModify2', GraphModify2, (), False, _M_omero.cmd._t_Request, (), (
        ('targetObjects', (), _M_omero.api._t_StringLongListMap),
        ('childOptions', (), _M_omero.cmd.graphs._t_ChildOptions),
        ('dryRun', (), IcePy._t_bool)
    ))
...
if not _M_omero.cmd.__dict__.has_key('Chgrp2'):
...
or the owner of the objects and a member of the target group.'''
    ...
    _M_omero.cmd._t_Chgrp2 = IcePy.defineClass('::omero::cmd::Chgrp2', Chgrp2, (), False, _M_omero.cmd._t_GraphModify2, (), (('groupId', (), IcePy._t_long),))
...
if not _M_omero.cmd.__dict__.has_key('Chgrp2Response'):
...
group.'''
    ...
    _M_omero.cmd._t_Chgrp2Response = IcePy.defineClass('::omero::cmd::Chgrp2Response', Chgrp2Response, (), False, _M_omero.cmd._t_OK, (), (
        ('includedObjects', (), _M_omero.api._t_StringLongListMap),
        ('deletedObjects', (), _M_omero.api._t_StringLongListMap)
    ))
...
if not _M_omero.cmd.__dict__.has_key('Chmod2'):
...
The only permitted target object type is ExperimenterGroup.'''
    ...
    _M_omero.cmd._t_Chmod2 = IcePy.defineClass('::omero::cmd::Chmod2', Chmod2, (), False, _M_omero.cmd._t_GraphModify2, (), (('permissions', (), IcePy._t_string),))
...
if not _M_omero.cmd.__dict__.has_key('Chmod2Response'):
    ...
    _M_omero.cmd._t_Chmod2Response = IcePy.defineClass('::omero::cmd::Chmod2Response', Chmod2Response, (), False, _M_omero.cmd._t_OK, (), (
        ('includedObjects', (), _M_omero.api._t_StringLongListMap),
        ('deletedObjects', (), _M_omero.api._t_StringLongListMap)
    ))
...
if not _M_omero.cmd.__dict__.has_key('Chown2'):
...
the target user a member of the objects' group.'''
    ...
    _M_omero.cmd._t_Chown2 = IcePy.defineClass('::omero::cmd::Chown2', Chown2, (), False, _M_omero.cmd._t_GraphModify2, (), (('userId', (), IcePy._t_long),))
...
if not _M_omero.cmd.__dict__.has_key('Chown2Response'):
    ...
    _M_omero.cmd._t_Chown2Response = IcePy.defineClass('::omero::cmd::Chown2Response', Chown2Response, (), False, _M_omero.cmd._t_OK, (), (
        ('includedObjects', (), _M_omero.api._t_StringLongListMap),
        ('deletedObjects', (), _M_omero.api._t_StringLongListMap)
    ))
...
if not _M_omero.cmd.__dict__.has_key('Delete2'):
    ...
    _M_omero.cmd._t_Delete2 = IcePy.defineClass('::omero::cmd::Delete2', Delete2, (), False, _M_omero.cmd._t_GraphModify2, (), ())
...
if not _M_omero.cmd.__dict__.has_key('Delete2Response'):
    ...
    _M_omero.cmd._t_Delete2Response = IcePy.defineClass('::omero::cmd::Delete2Response', Delete2Response, (), False, _M_omero.cmd._t_OK, (), (('deletedObjects', (), _M_omero.api._t_StringLongListMap),))
...
if not _M_omero.cmd.__dict__.has_key('SkipHead'):
...
is as from the given request.'''
    ...
    _M_omero.cmd._t_SkipHead = IcePy.defineClass('::omero::cmd::SkipHead', SkipHead, (), False, _M_omero.cmd._t_GraphModify2, (), (
        ('startFrom', (), _M_omero.api._t_StringSet),
        ('request', (), _M_omero.cmd._t_GraphModify2)
    ))
...
if not _M_omero.cmd.__dict__.has_key('GraphException'):
...
this instance.'''
    ...
    _M_omero.cmd._t_GraphException = IcePy.defineClass('::omero::cmd::GraphException', GraphException, (), False, _M_omero.cmd._t_ERR, (), (('message', (), IcePy._t_string),))
