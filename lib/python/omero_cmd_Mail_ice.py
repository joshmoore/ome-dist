...
if not _M_omero.cmd.__dict__.has_key('SendEmailRequest'):
...
- extra=[...] allows to set extra email address if not in DB'''
    ...
    _M_omero.cmd._t_SendEmailRequest = IcePy.defineClass('::omero::cmd::SendEmailRequest', SendEmailRequest, (), False, _M_omero.cmd._t_Request, (), (
        ('subject', (), IcePy._t_string),
        ('body', (), IcePy._t_string),
        ('html', (), IcePy._t_bool),
        ('userIds', (), _M_omero.sys._t_LongList),
        ('groupIds', (), _M_omero.sys._t_LongList),
        ('extra', (), _M_omero.api._t_StringSet),
        ('inactive', (), IcePy._t_bool),
        ('everyone', (), IcePy._t_bool)
    ))
...
if not _M_omero.cmd.__dict__.has_key('SendEmailResponse'):
...
- success is a number of emails that were sent successfully.'''
    ...
    _M_omero.cmd._t_SendEmailResponse = IcePy.defineClass('::omero::cmd::SendEmailResponse', SendEmailResponse, (), False, _M_omero.cmd._t_Response, (), (
        ('total', (), IcePy._t_long),
        ('success', (), IcePy._t_long),
        ('invalidusers', (), _M_omero.api._t_LongList),
        ('invalidemails', (), _M_omero.api._t_StringSet)
    ))
