...
if not _M_omero.model.__dict__.has_key('AnnotationAnnotationLink'):
    ...
    class AnnotationAnnotationLink(_M_omero.model.IObject):
        def __init__(self, _id=None, _details=None, _loaded=False, _version=None, _parent=None, _child=None):
            if __builtin__.type(self) == _M_omero.model.AnnotationAnnotationLink:
    ...
    AnnotationAnnotationLink.ice_type = _M_omero.model._t_AnnotationAnnotationLink
    ...
    AnnotationAnnotationLink._op_setChild = IcePy.Operation('setChild', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Annotation),), (), None, ())
    AnnotationAnnotationLink._op_link = IcePy.Operation('link', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Annotation), ((), _M_omero.model._t_Annotation)), (), None, ())
