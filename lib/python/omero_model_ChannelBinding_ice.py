...
if not _M_omero.model.__dict__.has_key('ChannelBinding'):
    ...
    class ChannelBinding(_M_omero.model.IObject):
        def __init__(self, _id=None, _details=None, _loaded=False, _version=None, _renderingDef=None, _family=None, _coefficient=None, _inputStart=None, _inputEnd=None, _active=None, _noiseReduction=None, _red=None, _green=None, _blue=None, _alpha=None, _lookupTable=None):
    ...
    _M_omero.model._t_ChannelBinding = IcePy.defineClass('::omero::model::ChannelBinding', ChannelBinding, (), True, _M_omero.model._t_IObject, (), (
        ...
        ('_lookupTable', (), _M_omero._t_RString)
    ))
    ...
    ChannelBinding._op_getLookupTable = IcePy.Operation('getLookupTable', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero._t_RString, ())
    ChannelBinding._op_setLookupTable = IcePy.Operation('setLookupTable', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero._t_RString),), (), None, ())
