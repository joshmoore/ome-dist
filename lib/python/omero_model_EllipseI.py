...
class EllipseI(_omero_model.Ellipse):
      ...
      _field_info = _field_info_type(
          ...
          ry=_field_info_data(wrapper=omero.rtypes.rdouble, nullable=True),
      ...
      def setRy(self, _ry, current = None, wrap=False):
          self.errorIfUnloaded()
          if wrap and self._field_info.ry.wrapper is not None:
              if _ry is not None:
                  _ry = self._field_info.ry.wrapper(_ry)
          self._ry = _ry
          pass
