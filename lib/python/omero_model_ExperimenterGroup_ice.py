...
if not _M_omero.model.__dict__.has_key('ExperimenterGroup'):
    ...
    _M_omero.model._t_ExperimenterGroup = IcePy.defineClass('::omero::model::ExperimenterGroup', ExperimenterGroup, (), True, _M_omero.model._t_IObject, (), (
        ...
        ('_config', (), _M_omero.api._t_NamedValueList),
    ...
    ExperimenterGroup._op_getLdap = IcePy.Operation('getLdap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero._t_RBool, ())
    ExperimenterGroup._op_setLdap = IcePy.Operation('setLdap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero._t_RBool),), (), None, ())
    ...
    ExperimenterGroup._op_getConfigAsMap = IcePy.Operation('getConfigAsMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_StringStringMap, ())
    ExperimenterGroup._op_getConfig = IcePy.Operation('getConfig', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_NamedValueList, ())
    ExperimenterGroup._op_setConfig = IcePy.Operation('setConfig', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.api._t_NamedValueList),), (), None, ())
