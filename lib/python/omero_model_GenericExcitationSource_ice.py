...
if not _M_omero.model.__dict__.has_key('GenericExcitationSource'):
    ...
    class GenericExcitationSource(_M_omero.model.LightSource):
        def __init__(self, _id=None, _details=None, _loaded=False, _version=None, _manufacturer=None, _model=None, _power=None, _lotNumber=None, _serialNumber=None, _instrument=None, _annotationLinksSeq=None, _annotationLinksLoaded=False, _annotationLinksCountPerOwner=None, _map=None):
            if __builtin__.type(self) == _M_omero.model.GenericExcitationSource:
    ...
    _M_omero.model._t_GenericExcitationSource = IcePy.defineClass('::omero::model::GenericExcitationSource', GenericExcitationSource, (), True, _M_omero.model._t_LightSource, (), (('_map', (), _M_omero.api._t_NamedValueList),))
    GenericExcitationSource._ice_type = _M_omero.model._t_GenericExcitationSource

    GenericExcitationSource._op_getMapAsMap = IcePy.Operation('getMapAsMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_StringStringMap, ())
    GenericExcitationSource._op_getMap = IcePy.Operation('getMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_NamedValueList, ())
    GenericExcitationSource._op_setMap = IcePy.Operation('setMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.api._t_NamedValueList),), (), None, ())
