...
if not _M_omero.model.__dict__.has_key('Temperature'):
...
if not _M_omero.model.__dict__.has_key('Pressure'):
...
if not _M_omero.model.__dict__.has_key('ImagingEnvironment'):
    ...
    _M_omero.model._t_ImagingEnvironment = IcePy.defineClass('::omero::model::ImagingEnvironment', ImagingEnvironment, (), True, _M_omero.model._t_IObject, (), (
        ...
        ('_temperature', (), _M_omero.model._t_Temperature),
        ('_airPressure', (), _M_omero.model._t_Pressure),
        ('_humidity', (), _M_omero._t_RDouble),
        ('_co2percent', (), _M_omero._t_RDouble),
        ('_map', (), _M_omero.api._t_NamedValueList)
    ))
    ...
    ImagingEnvironment._op_getTemperature = IcePy.Operation('getTemperature', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Temperature, ())
    ImagingEnvironment._op_setTemperature = IcePy.Operation('setTemperature', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Temperature),), (), None, ())
    ImagingEnvironment._op_getAirPressure = IcePy.Operation('getAirPressure', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Pressure, ())
    ImagingEnvironment._op_setAirPressure = IcePy.Operation('setAirPressure', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Pressure),), (), None, ())
    ...
    ImagingEnvironment._op_getMapAsMap = IcePy.Operation('getMapAsMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_StringStringMap, ())
    ImagingEnvironment._op_getMap = IcePy.Operation('getMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_NamedValueList, ())
    ImagingEnvironment._op_setMap = IcePy.Operation('setMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.api._t_NamedValueList),), (), None, ())
