...
if not _M_omero.model.__dict__.has_key('IndexingJob'):
    ...
    class IndexingJob(_M_omero.model.Job):
        def __init__(self, _id=None, _details=None, _loaded=False, _version=None, _username=None, _groupname=None, _type=None, _message=None, _status=None, _submitted=None, _scheduledFor=None, _started=None, _finished=None, _originalFileLinksSeq=None, _originalFileLinksLoaded=False, _originalFileLinksCountPerOwner=None):
            if __builtin__.type(self) == _M_omero.model.IndexingJob:
    ...
    _M_omero.model._t_IndexingJob = IcePy.defineClass('::omero::model::IndexingJob', IndexingJob, (), True, _M_omero.model._t_Job, (), ())
    IndexingJob.ice_type = _M_omero.model._t_IndexingJob
