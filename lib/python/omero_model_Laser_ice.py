...
if not _M_omero.model.__dict__.has_key('Laser'):
    ...
    _M_omero.model._t_Laser = IcePy.defineClass('::omero::model::Laser', Laser, (), True, _M_omero.model._t_LightSource, (), (
        ...
        ('_wavelength', (), _M_omero.model._t_Length),
        ('_pockelCell', (), _M_omero._t_RBool),
        ('_pump', (), _M_omero.model._t_LightSource),
        ('_repetitionRate', (), _M_omero.model._t_Frequency)
    ))
    ...
    Laser._op_getWavelength = IcePy.Operation('getWavelength', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Length, ())
    Laser._op_setWavelength = IcePy.Operation('setWavelength', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Length),), (), None, ())
    ...
    Laser._op_getRepetitionRate = IcePy.Operation('getRepetitionRate', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Frequency, ())
    Laser._op_setRepetitionRate = IcePy.Operation('setRepetitionRate', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Frequency),), (), None, ())
