...
and pixels.physicalSizeXUnit).'''
        def __init__(self, _value=0.0, _unit=_M_omero.model.enums.UnitsLength.YOTTAMETER):
            if __builtin__.type(self) == _M_omero.model.Length:
...
value for display.'''
    ...
    _M_omero.model._t_Length = IcePy.defineClass('::omero::model::Length', Length, (), True, None, (), (
        ('_value', (), IcePy._t_double),
        ('_unit', (), _M_omero.model.enums._t_UnitsLength)
    ))
    Length._ice_type = _M_omero.model._t_Length

    Length._op_getValue = IcePy.Operation('getValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), IcePy._t_double, ())
    Length._op_setValue = IcePy.Operation('setValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), IcePy._t_double),), (), None, ())
    Length._op_getUnit = IcePy.Operation('getUnit', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model.enums._t_UnitsLength, ())
    Length._op_setUnit = IcePy.Operation('setUnit', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model.enums._t_UnitsLength),), (), None, ())
    Length._op_getSymbol = IcePy.Operation('getSymbol', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), IcePy._t_string, ())
    Length._op_copy = IcePy.Operation('copy', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Length, ())
