...
if not _M_omero.model.__dict__.has_key('MetadataImportJob'):
    ...
    _M_omero.model._t_MetadataImportJob = IcePy.defineClass('::omero::model::MetadataImportJob', MetadataImportJob, (), True, _M_omero.model._t_Job, (), (('_versionInfo', (), _M_omero.api._t_NamedValueList),))
    MetadataImportJob._ice_type = _M_omero.model._t_MetadataImportJob

    MetadataImportJob._op_getVersionInfoAsMap = IcePy.Operation('getVersionInfoAsMap', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_StringStringMap, ())
    MetadataImportJob._op_getVersionInfo = IcePy.Operation('getVersionInfo', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.api._t_NamedValueList, ())
    MetadataImportJob._op_setVersionInfo = IcePy.Operation('setVersionInfo', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.api._t_NamedValueList),), (), None, ())
