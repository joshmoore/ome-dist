...
if not _M_omero.model.__dict__.has_key('_t_OriginalFileFilesetEntriesSeq'):
...
if not _M_omero.model.__dict__.has_key('OriginalFile'):
    ...
    _M_omero.model._t_OriginalFile = IcePy.defineClass('::omero::model::OriginalFile', OriginalFile, (), True, _M_omero.model._t_IObject, (), (
        ...
        ('_filesetEntriesSeq', (), _M_omero.model._t_OriginalFileFilesetEntriesSeq),
        ('_filesetEntriesLoaded', (), IcePy._t_bool),
    ...
    OriginalFile._op_unloadFilesetEntries = IcePy.Operation('unloadFilesetEntries', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), None, ())
    OriginalFile._op_sizeOfFilesetEntries = IcePy.Operation('sizeOfFilesetEntries', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), IcePy._t_int, ())
    OriginalFile._op_copyFilesetEntries = IcePy.Operation('copyFilesetEntries', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_OriginalFileFilesetEntriesSeq, ())
    OriginalFile._op_addFilesetEntry = IcePy.Operation('addFilesetEntry', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_FilesetEntry),), (), None, ())
    OriginalFile._op_addAllFilesetEntrySet = IcePy.Operation('addAllFilesetEntrySet', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_OriginalFileFilesetEntriesSeq),), (), None, ())
    OriginalFile._op_removeFilesetEntry = IcePy.Operation('removeFilesetEntry', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_FilesetEntry),), (), None, ())
    OriginalFile._op_removeAllFilesetEntrySet = IcePy.Operation('removeAllFilesetEntrySet', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_OriginalFileFilesetEntriesSeq),), (), None, ())
    OriginalFile._op_clearFilesetEntries = IcePy.Operation('clearFilesetEntries', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), None, ())
    OriginalFile._op_reloadFilesetEntries = IcePy.Operation('reloadFilesetEntries', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_OriginalFile),), (), None, ())
