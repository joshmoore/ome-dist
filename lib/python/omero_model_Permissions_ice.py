...
already identifies that it's readable.'''
    ...
    _M_omero.model._t_Permissions = IcePy.defineClass('::omero::model::Permissions', Permissions, (), True, None, (), (
        ...
        ('_extendedRestrictions', (), _M_omero.api._t_StringSet),
    ...
    Permissions._op_isRestricted = IcePy.Operation('isRestricted', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), IcePy._t_string),), (), IcePy._t_bool, ())
