...
if not _M_omero.model.__dict__.has_key('PixelsType'):
    ...
    class PixelsType(_M_omero.model.IObject):
        def __init__(self, _id=None, _details=None, _loaded=False, _value=None, _bitSize=None):
            if __builtin__.type(self) == _M_omero.model.PixelsType:
    ...
    _M_omero.model._t_PixelsType = IcePy.defineClass('::omero::model::PixelsType', PixelsType, (), True, _M_omero.model._t_IObject, (), (
        ('_value', (), _M_omero._t_RString),
        ('_bitSize', (), _M_omero._t_RInt)
    ))
    PixelsType.ice_type = _M_omero.model._t_PixelsType

    PixelsType._op_getValue = IcePy.Operation('getValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero._t_RString, ())
    PixelsType._op_setValue = IcePy.Operation('setValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero._t_RString),), (), None, ())
    PixelsType._op_getBitSize = IcePy.Operation('getBitSize', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero._t_RInt, ())
    PixelsType._op_setBitSize = IcePy.Operation('setBitSize', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero._t_RInt),), (), None, ())
