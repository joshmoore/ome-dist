...
if not _M_omero.model.__dict__.has_key('Pixels'):
    ...
    _M_omero.model._t_Pixels = IcePy.defineClass('::omero::model::Pixels', Pixels, (), True, _M_omero.model._t_IObject, (), (
        ...
        ('_physicalSizeX', (), _M_omero.model._t_Length),
        ('_physicalSizeY', (), _M_omero.model._t_Length),
        ('_physicalSizeZ', (), _M_omero.model._t_Length),
        ('_waveStart', (), _M_omero._t_RInt),
        ('_waveIncrement', (), _M_omero._t_RInt),
        ('_timeIncrement', (), _M_omero.model._t_Time),
    ...
    Pixels._op_getPhysicalSizeX = IcePy.Operation('getPhysicalSizeX', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Length, ())
    Pixels._op_setPhysicalSizeX = IcePy.Operation('setPhysicalSizeX', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Length),), (), None, ())
    Pixels._op_getPhysicalSizeY = IcePy.Operation('getPhysicalSizeY', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Length, ())
    Pixels._op_setPhysicalSizeY = IcePy.Operation('setPhysicalSizeY', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Length),), (), None, ())
    Pixels._op_getPhysicalSizeZ = IcePy.Operation('getPhysicalSizeZ', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Length, ())
    Pixels._op_setPhysicalSizeZ = IcePy.Operation('setPhysicalSizeZ', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Length),), (), None, ())
    ...
    Pixels._op_getTimeIncrement = IcePy.Operation('getTimeIncrement', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Time, ())
    Pixels._op_setTimeIncrement = IcePy.Operation('setTimeIncrement', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model._t_Time),), (), None, ())
