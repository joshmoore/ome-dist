...
and imagingEnvironment.pressureUnit).'''
        def __init__(self, _value=0.0, _unit=_M_omero.model.enums.UnitsPressure.YOTTAPASCAL):
            if __builtin__.type(self) == _M_omero.model.Pressure:
...
value for display.'''
    ...
    _M_omero.model._t_Pressure = IcePy.defineClass('::omero::model::Pressure', Pressure, (), True, None, (), (
        ('_value', (), IcePy._t_double),
        ('_unit', (), _M_omero.model.enums._t_UnitsPressure)
    ))
    Pressure._ice_type = _M_omero.model._t_Pressure

    Pressure._op_getValue = IcePy.Operation('getValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), IcePy._t_double, ())
    Pressure._op_setValue = IcePy.Operation('setValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), IcePy._t_double),), (), None, ())
    Pressure._op_getUnit = IcePy.Operation('getUnit', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model.enums._t_UnitsPressure, ())
    Pressure._op_setUnit = IcePy.Operation('setUnit', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero.model.enums._t_UnitsPressure),), (), None, ())
    Pressure._op_getSymbol = IcePy.Operation('getSymbol', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), IcePy._t_string, ())
    Pressure._op_copy = IcePy.Operation('copy', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero.model._t_Pressure, ())
