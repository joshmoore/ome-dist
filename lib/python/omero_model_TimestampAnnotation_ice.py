...
if not _M_omero.model.__dict__.has_key('TimestampAnnotation'):
    _M_omero.model.TimestampAnnotation = Ice.createTempClass()
    class TimestampAnnotation(_M_omero.model.BasicAnnotation):
        def __init__(self, _id=None, _details=None, _loaded=False, _version=None, _ns=None, _description=None, _annotationLinksSeq=None, _annotationLinksLoaded=False, _annotationLinksCountPerOwner=None, _timeValue=None):
            if __builtin__.type(self) == _M_omero.model.TimestampAnnotation:
    ...
    _M_omero.model._t_TimestampAnnotation = IcePy.defineClass('::omero::model::TimestampAnnotation', TimestampAnnotation, (), True, _M_omero.model._t_BasicAnnotation, (), (('_timeValue', (), _M_omero._t_RTime),))
    TimestampAnnotation.ice_type = _M_omero.model._t_TimestampAnnotation

    TimestampAnnotation._op_getTimeValue = IcePy.Operation('getTimeValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (), (), _M_omero._t_RTime, ())
    TimestampAnnotation._op_setTimeValue = IcePy.Operation('setTimeValue', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, (), (((), _M_omero._t_RTime),), (), None, ())
