...
if not _M_omero.model.__dict__.has_key('TypeAnnotation'):
    ...
    class TypeAnnotation(_M_omero.model.Annotation):
        def __init__(self, _id=None, _details=None, _loaded=False, _version=None, _ns=None, _description=None, _annotationLinksSeq=None, _annotationLinksLoaded=False, _annotationLinksCountPerOwner=None):
            if __builtin__.type(self) == _M_omero.model.TypeAnnotation:
    ...
    _M_omero.model._t_TypeAnnotation = IcePy.defineClass('::omero::model::TypeAnnotation', TypeAnnotation, (), True, _M_omero.model._t_Annotation, (), ())
    TypeAnnotation.ice_type = _M_omero.model._t_TypeAnnotation
